...
Attempted to run some profiling with 3D Mark; The [first run](https://www.3dmark.com/3dm/156654054) **18904 (22297, 10151)** was with OBS running and streaming and no changes. Then simunaut mentioned I should turn off HVCI, Windows Security > Device Security > Core Isolation Details turned Memory Integration from on to off. I also rebooted, went into bios and turned off "Legacy Game Compatibility Mode" which would do something if scroll light on keyboard was on... which never happened afaik. The [second run](https://www.3dmark.com/3dm/156656217?) **28245 (32617, 16054)** was after the restart and closing down all background apps (AutoHotKey, StreamDeck, Slack etc) except for the apps mentioned in 2026-03-04. I then started OBS and streamed to extras channel for the [third run](https://www.3dmark.com/3dm/156656533?) **23674 (27517, 13215)** resulting in the middle. This was tested in an iRacing Test session, stationary in a pitbox, no other cars, at Bathurst getting 160-170 fps with actual mirrors, but occasional dips down to 116-120.
